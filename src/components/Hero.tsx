...
const Hero = () => {
  ...
  return (
    <div
      className="relative md:h-[calc(100vh-70px)] "
    ...
    >
      ...
      <div
        className={`px-2 z-10 md:text-right lg:pt-10 lg:pr-8 xl:pt-16 xl:pr-20 md:pt-10 pr-2 md:bg-transparent text-center  py-10 md:py-0 2xl:pt-24 2xl:pr-32 ${
          i18n.language === "en" &&
          "flex justify-center flex-col md:items-end items-center"
        }`}
      >
